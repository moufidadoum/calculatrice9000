...
Button(root,text="/", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: show("/")).place(x=150,y=100)
Button(root,text="%", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: show("%")).place(x=290,y=100)
Button(root,text="*", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: show("*")).place(x=430,y=100)
Button(root,text="√", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: sqrt()).place(x=570,y=100)
...
Button(root,text="-", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: show("-")).place(x=430,y=200)
Button(root,text="x²", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: carre()).place(x=570,y=200)
...
Button(root,text="+", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: show("+")).place(x=430,y=300)
Button(root,text="x³", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: cube()).place(x=570,y=300)
...
Button(root, text="pour%", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5", command=lambda: percentage()).place(x=570,y=400)
Button(root, text="H", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#000", bg="#3697f5", command=lambda: history_window()).place(x=570, y=500)


Button(root,text=".", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#000",bg="#e5e5e5",command=lambda: show(".")).place(x=290,y=500)
Button(root,text="=", width=5, height=3, font=("arial",30,"bold"), bd=1,fg="#000",bg="#fe9037",command=lambda: calculate()).place(x=430,y=400)
